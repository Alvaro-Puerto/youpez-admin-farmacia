...
export class LayoutComponent implements OnInit, OnDestroy {
  ...
  public menu: Array<MenuType> = [
    {
       groupName: 'Administracion de ventas',
      opened: true,
      children: [
        {
          name: 'Ventas',
          url: '/app/ventas/ventas',
          permiso: 'ver ventas',
          prefix: {
            type: 'ibm-icon',
            name: 'home',
    ...
    {
      groupName: 'Administracion de clientes',
      opened: true,
      children: [
        {
          name: 'Administrar clientes',
          url: '/app/ventas/clientes',
    ...
    },
    {
      ...
      children: [
        {
          name: 'Articulos',
          permiso: 'ver articulos',
          url: '/app/ventas/articulo',
          prefix: {
            type: 'ibm-icon',
            name: 'home',
          },
        ...
        },
        {
          ...
          url: '/app/ventas/um',
          permiso: 'ver unidades de medida',
          prefix: {
            type: 'ibm-icon',
            name: 'analytics',
          },
    ...
    },
    {
      ...
      children: [
        ...
        {
          name: 'Restauracion y respaldos BD',
          permiso: 'respaldo bd',
          url: '/app/seguridad/backups',
          prefix: {
            type: 'ibm-icon',
            name: 'activity',
          },
